...
assert 'optional-elements-modeMinimum' == originalProject.artifactId.text()
...
assert 'optional-elements-modeMinimum' == flattendProject.artifactId.text()
...
assert 1 == flattendProject.pluginRepositories.size()
