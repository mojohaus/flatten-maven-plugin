...

{
    ...
    assert '0.0.1-SNAPSHOT' == flattenedBom.properties.'interpolated-project-version'.text()
    assert '0.0.1-SNAPSHOT' == flattenedBom.dependencyManagement.dependencies.dependency[0].version.text()
}
