...
}
{
    ...
    assert '3.1.2' == flattenedBom.properties.'interpolated-version-springboot'.text()
    assert '3.1.2' == flattenedBom.dependencyManagement.dependencies.dependency[0].version.text()
