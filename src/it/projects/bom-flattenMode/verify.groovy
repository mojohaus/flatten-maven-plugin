...
assert 1 == originalProject.build.pluginManagement.size()
assert 1 == originalProject.build.pluginManagement.plugins.size()
assert 4 == originalProject.build.pluginManagement.plugins.plugin.size()
...
assert 'maven-compiler-plugin' == flattendProject.build.pluginManagement.plugins.plugin[0].artifactId.text()
assert '3.11.0' == flattendProject.build.pluginManagement.plugins.plugin[0].version.text()
